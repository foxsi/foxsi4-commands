...
std::unordered_map<char, MemData> COMMAND_LOOKUP = {
	...
	{0x8E, (struct MemData){0x4d, 0x022b0308, 0x0c}},
	{0x98, (struct MemData){0x4d, 0x00, 0x00}},
	{0x9A, (struct MemData){0x4d, 0x022b02fc, 0x0c}},
	{0x9C, (struct MemData){0x4d, 0x00, 0x00}},
	{0x9D, (struct MemData){0x4d, 0x00, 0x08}},
	...
	{0x18, (struct MemData){0x7d, 0x00, 0x00}},
	{0x1F, (struct MemData){0x7d, 0x00, 0x00}},
	{0x10, (struct MemData){0x7d, 0x00, 0x00}},
	{0x11, (struct MemData){0x7d, 0x00, 0x00}},
	{0x12, (struct MemData){0x7d, 0x00, 0x00}},
	{0x13, (struct MemData){0x7d, 0x00, 0x00}},
	{0x14, (struct MemData){0x7d, 0x022b0000, 0x00}},
	{0x15, (struct MemData){0x7d, 0x022b0000, 0x00}},
	{0x16, (struct MemData){0x7d, 0x022b0000, 0x00}},
	{0x17, (struct MemData){0x7d, 0x022b0000, 0x00}},
