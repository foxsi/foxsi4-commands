...
std::unordered_map<char, MemData> COMMAND_LOOKUP = {
	...
	{0x8E, (struct MemData){0x4d, 0x00000244, 0x04}},
	{0x9F, (struct MemData){0x4d, 0x00000248, 0x04}},
	{0x9A, (struct MemData){0x4d, 0x00, 0x0c}},
	{0x9C, (struct MemData){0x4d, 0x000001f4, 0x04}},
	{0x9D, (struct MemData){0x4d, 0x000001f0, 0x04}},
	{0xA1, (struct MemData){0x4d, 0x00, 0x02}},
	{0xA4, (struct MemData){0x4d, 0x00, 0x00}},
	{0xA8, (struct MemData){0x4d, 0x00, 0x00}},
	{0x98, (struct MemData){0x4d, 0x0000100, 0x04}},
